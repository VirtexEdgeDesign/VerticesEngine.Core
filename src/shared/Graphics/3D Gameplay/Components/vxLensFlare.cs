...
namespace VerticesEngine.Graphics
{
    ...
    /// </summary>
    public class vxLensFlareComponent// : DrawableGameComponent
    {
        #region Constants


        // How big is the circular glow effect?
        const float glowSize = 250;
        ...
        public Vector3 LightDirection = Vector3.Normalize(new Vector3(-1, -0.1f, 0.03f));
        ...
        Flare[] flares =
        {
            new Flare(-0.5f, 0.7f, new Color( 50,  25,  50), "vxengine/textures/lensflares/flare1"),
            new Flare( 0.3f, 0.4f, new Color(100, 255, 200), "vxengine/textures/lensflares/flare1"),
            new Flare( 1.2f, 1.0f, new Color(100,  50,  50), "vxengine/textures/lensflares/flare1"),
            new Flare( 1.5f, 1.5f, new Color( 50, 100,  50), "vxengine/textures/lensflares/flare1"),

            new Flare(-0.3f, 0.7f, new Color(200,  50,  50), "vxengine/textures/lensflares/flare2"),
            new Flare( 0.6f, 0.9f, new Color( 50, 100,  50), "vxengine/textures/lensflares/flare2"),
            new Flare( 0.7f, 0.4f, new Color( 50, 200, 200), "vxengine/textures/lensflares/flare2"),

            new Flare(-0.7f, 0.7f, new Color( 50, 100,  25), "vxengine/textures/lensflares/flare3"),
            new Flare( 0.0f, 0.6f, new Color( 25,  25,  25), "vxengine/textures/lensflares/flare3"),
            new Flare( 2.0f, 1.4f, new Color( 25,  50, 100), "vxengine/textures/lensflares/flare3"), 
        };
        ...
        public void LoadContent()
        {
            ...
            spriteBatch = new SpriteBatch(vxGraphics.GraphicsDevice);

            // Load the glow and flare textures.
            glowSprite = vxInternalAssets.Textures.LensFlareGlow;

            foreach (Flare flare in flares)
            {
                flare.Texture = vxContentManager.Instance.Load<Texture2D>(flare.TextureName);
            }
        ...
        {
            LightDirection = vxSunEntity.Instance.LightDirection;
        ...
        public void DrawGlow()
        {
            ...
            spriteBatch.Begin(0, effect: vxInternalAssets.PostProcessShaders.LensFlareEffect);
            //spriteBatch.Begin();
        ...
        public void DrawFlares()
        {
            ...
            spriteBatch.Begin(0, BlendState.Additive, effect: vxInternalAssets.PostProcessShaders.LensFlareEffect);
