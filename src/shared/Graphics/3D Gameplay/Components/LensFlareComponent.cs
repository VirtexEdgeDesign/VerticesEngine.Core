...
#region Fields
		...
		/// </summary>
		/// <value>The render targets.</value>
		//public vxRenderTargetsCollection RenderTargets
		//{
		//	get { return Renderer.RenderTargets; }
		//}
...
#region Initialization
        ...
        /// </summary>
        public LensFlareComponent(vxGameplayScene3D Scene)
        {
            this.Scene = Scene;
        }
        ...
        public void LoadContent()
        {
            ...
            glowSprite = vxInternalContentManager.Instance.Load<Texture2D>("Graphics/Flares/glow");
            
            foreach (Flare flare in flares)
            {
                flare.Texture = vxInternalContentManager.Instance.Load<Texture2D>(flare.TextureName);
            }
            ...
            //occlusionQuery = new OcclusionQuery(vxGraphics.GraphicsDevice);
        }
...
#region Draw
        ...
        public void Draw(GameTime gameTime)
        {
			...
			lightPosition = new Vector2(Scene.SunEmitter.ScreenSpacePosition.X, 
			                            Scene.SunEmitter.ScreenSpacePosition.Y);
        ...
        {
			//Texture2D depth = RenderTargets.DepthMap;

			//vxConsole.WriteToInGameDebug(vxTexture2D.GetPixel(depth, 2, 2, vxGraphics.GraphicsDevice.Viewport.Width).R);
			/*
            ...
            vxGraphics.GraphicsDevice.BlendState = ColorWriteDisable;
            vxGraphics.GraphicsDevice.DepthStencilState = DepthStencilState.DepthRead;
            ...
            vxGraphics.GraphicsDevice.DrawUserPrimitives(PrimitiveType.TriangleStrip, queryVertices, 0, 2);
