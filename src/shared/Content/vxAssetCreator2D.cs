...
namespace VerticesEngine.Graphics
{
	...
	/// </summary>
	public static class vxAssetCreator2D
    {
		...
		static Dictionary<MaterialType, Texture2D> _materials = new Dictionary<MaterialType, Texture2D>();
		...
		internal static void Init()
		{
            ...
            _device = vxGraphics.GraphicsDevice;
			_effect = new BasicEffect(_device);

            _materials[MaterialType.Blank] = vxContentManager.Instance.Load<Texture2D>("vxengine/textures/Materials/blank");
            _materials[MaterialType.Dots] = vxContentManager.Instance.Load<Texture2D>("vxengine/textures/Materials/dots");
            _materials[MaterialType.Squares] = vxContentManager.Instance.Load<Texture2D>("vxengine/textures/Materials/squares");
            _materials[MaterialType.Waves] = vxContentManager.Instance.Load<Texture2D>("vxengine/textures/Materials/waves");
            _materials[MaterialType.Pavement] = vxContentManager.Instance.Load<Texture2D>("vxengine/textures/Materials/pavement");
        }
        ...
        public static Texture2D TextureFromShape(Shape shape, MaterialType type, Color color, float materialScale)
		{
        ...
        public static Texture2D TextureFromVertices(Vertices vertices, MaterialType type, Color color, float materialScale)
		{
			return TextureFromVertices (vertices, type, color, materialScale, Color.Black);
		}


        public static Texture2D TextureFromVertices(Vertices vertices, MaterialType type, Color color, float materialScale, Color EdgeColor)
		{
			// copy vertices
        ...
        public static Texture2D CircleTexture(float radius, MaterialType type, Color color, float materialScale)
		{
			return EllipseTexture(radius, radius, type, color, materialScale);
		}


        public static Texture2D EllipseTexture(float radiusX, float radiusY, MaterialType type, Color color, float materialScale)
		{
		...
		static Texture2D RenderTexture(int width, int height, Texture2D material, VertexPositionColorTexture[] verticesFill, VertexPositionColor[] verticesOutline)
		{
        ...
        static Texture2D RenderTexture(int width, int height, Texture2D material, List<VertexPositionColorTexture[]> verticesFill, VertexPositionColor[] verticesOutline)
		{
