...
namespace VerticesEngine
{
    ...
    public class vxEngineAttribute : Attribute
    {
    ...
    /// <summary>
    /// An engine specific setting which should be serialised to an *.ini file.
    /// </summary>
    [System.AttributeUsage(System.AttributeTargets.Field | AttributeTargets.Property, AllowMultiple = true)]
    public class vxEngineSettingsAttribute : vxSettingsAttribute
    {
        /// <summary>
        ...
        public vxEngineSettingsAttribute(string displayname, string description = "", bool isSavedToINI = true, bool isMenuSetting = true, 
