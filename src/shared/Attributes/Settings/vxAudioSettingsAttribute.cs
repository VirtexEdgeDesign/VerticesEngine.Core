...
namespace VerticesEngine
{
    ...
    public class vxAudioSettingsAttribute : vxSettingsAttribute
    {
        ...
        public vxAudioSettingsAttribute(string displayname, string description = "") : base(displayname, description)
        {
