...
namespace VerticesEngine.Controllers
{
    ...
    public class CharacterControllerInput
    {
        ...
        /// </summary>
        public BEPUphysics.Space Space { get; private set; }
		...
		public CharacterControllerInput(BEPUphysics.Space owningSpace, vxCamera3D camera, vxEngine Engine)
        {
            CharacterController = new CharacterController();
            Camera = camera;
            CameraControlScheme = new CharacterCameraControlScheme(CharacterController, camera, Engine);
