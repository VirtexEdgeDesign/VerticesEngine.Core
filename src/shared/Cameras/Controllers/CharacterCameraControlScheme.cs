...
namespace VerticesEngine.Controllers
{
    public class CharacterCameraControlScheme : CameraControlScheme
    {
		...
		public CharacterCameraControlScheme(CharacterController character, vxCamera3D camera, vxEngine Engine)
            : base(camera, Engine)
        {
            Character = character;
        ...
        public override void Update(float dt)
        {
            ...
            if (UseCameraSmoothing)
            {
                ...
                if (vxEngine.BuildType == vxBuildType.Debug)
                    vxConsole.WriteToScreen(this, "MaximumStepHeight: " + Character.StepManager.MaximumStepHeight);
